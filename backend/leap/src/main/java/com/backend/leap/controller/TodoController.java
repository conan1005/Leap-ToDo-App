...
import com.backend.leap.service.TodoService;
...
public class TodoController {
    ...
    public ResponseEntity<Todo> read(@PathVariable long id, Principal principal) throws Exception {
    ...
    public ResponseEntity<Todo> markComplete(@PathVariable long id, Principal principal) throws Exception {
    ...
    public ResponseEntity<Todo> update(@PathVariable long id, @Valid @RequestBody TodoUpdateRequest todoUpdateRequest, Principal principal) throws Exception {
