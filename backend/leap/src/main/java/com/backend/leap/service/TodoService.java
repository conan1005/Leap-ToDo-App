...
import com.backend.leap.controller.CountResponse;
...
import com.backend.leap.repository.TodoPagingRepository;
...
public class TodoService {
    ...
    public CountResponse countAllByIsCompleted(String username, String isCompleted) throws Exception {
        boolean _isCompleted = isCompletedStringToBoolean(isCompleted);
